              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(':',
                        style:
                            TextStyle(fontSize: 40, color: Colors.green[700]))
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                                                        ...
                                                        child: Container(
                                                            decoration: BoxDecoration(
                                                                image: DecorationImage(
                                                                    ...
                                                                    image: FileImage(File(plantsToWater[index].plant.picturePath))))))),
                                            Column(
                                              mainAxisAlignment:
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    RawMaterialButton(
                                      ...
                                      onPressed: () {
                                        widget.wateringService.waterPlant(
                                            plantsToWater[index].index);
                                        plantsToWater = widget.wateringService
